...
public class Vec3Pool
{
     ...
     */
    public Vec3d getVecFromPool(double par1, double par3, double par5)
    {
    ...
    public Vec3d getVecFromPool(Vec3d vec3_to_copy)
    {
        return this.getVecFromPool(vec3_to_copy.x, vec3_to_copy.y, vec3_to_copy.z);
    }
